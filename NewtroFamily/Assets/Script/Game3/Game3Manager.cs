        ...
        if (isTimer)
        {
            ...
            if (time <= 0.0f)
            {
                ...
                if (p_num == 1)
                {
                    // 점수 데이터에 합산
                    flowM.score[0] += count;
                    flowM.score3[0] = count;    // 딱지뒤집기 점수 저장
                ...
                else if (p_num == 2)
                {
                    // 점수 데이터에 합산
                    flowM.score[1] += count;
                    flowM.score3[1] = count;    // 딱지뒤집기 점수 저장
                ...
                else if (p_num == 3)
                {
                    // 점수 데이터에 합산
                    flowM.score[2] += count;
                    flowM.score3[2] = count;    // 딱지뒤집기 점수 저장
                ...
                else if (p_num == 4)
                {
                    // 점수 데이터에 합산
                    flowM.score[3] += count;
                    flowM.score3[3] = count;    // 딱지뒤집기 점수 저장
